 ...
 * @Version 1.0
 */
public class CassandraMigrationAuto {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //6080afd9-f939-4cfd-a3f8-efd50401f6a5		SH_AL算法A版		    有       已迁移
            //59d670ba-d9f3-4c40-b023-1fa1b3e5d37f		石化功能测试-报警		有       已迁移
            ...
            String[] masterWorkflows = {"6080afd9-f939-4cfd-a3f8-efd50401f6a5"};
            String[] slaveWorkflows = {"c41ce173-9a86-485f-a7e6-d354c01efa4e"};

//            String[] ips = {"172.16.3.1", "172.16.3.2", "172.16.3.3", "172.16.3.4"};
            String[] ips = {"172.16.3.101", "172.16.3.102", "172.16.3.103", "172.16.3.104"};
//            String[] ips_bakup = {"172.16.3.101", "172.16.3.102", "172.16.3.103", "172.16.3.104"};
//            String[] ips_bakup = {"172.16.3.1", "172.16.3.2", "172.16.3.3", "172.16.3.4"};
            String[] ips_bakup = {"172.16.5.14", "172.16.5.15", "172.16.5.16"};
            //Cassandra建立连接
            ...
            int var = 1;
            boolean replace = slaveWorkflows.length > 0;
            for (String workflowid : masterWorkflows) {
                int remain = size;
                while (remain > 0) {
                    try {
                                ...
                                for (Row row : resultSet) {
                                    ...
                                    if (null != wkid && null != asset)
                                        session_bakup.execute(String.format("insert into dat_algorithm_cache(workflowid,assetid,buffer,metadata) VALUES (%s,%s,'%s','%s')",
                                                replace ? slaveWorkflows[var - 1] : wkid.toString(), asset.toString(), row.getString("buffer"), row.getString("metadata")));
                                }
                                remain--;
                            }
                        ...
                        System.out.println("################################################################################");
                        System.out.println("重新迁移第" + var + "个工作流数据");
                    }
                }
                var++;
            }
